...
class AvailableOngScreen extends StatefulWidget {
  final bool isOng;

  const AvailableOngScreen({super.key, required this.isOng});

  @override
  State<AvailableOngScreen> createState() => _AvailableOngScreenState();
}

class _AvailableOngScreenState extends State<AvailableOngScreen> {
