...
class HomePage extends StatelessWidget {
  ...
  final List<PostData> posts = [
    ...
    PostData(
      ...
      caption:
          'Muito obrigado a todos pela participação na distribuição das marmitas ontem. Nossa paróquia vem trabalhando duro...',
      likes: 25,
      comments: 18,
    ),
    ...
    PostData(
      ...
      timeAgo: 'Há 1 dia',
      imageUrl:
          'https://images.pexels.com/photos/460452/pexels-photo-460452.jpeg',
    ...
    PostData(
      ...
      timeAgo: 'Há 3 dias',
      imageUrl:
          'https://images.pexels.com/photos/4827/nature-tree-forest-industry.jpg',
